...
instance_create_layer(50 * CELL_DIMENSION,
50 * CELL_DIMENSION, "Instances", obj_player_origin)
instance_create_layer(50 * CELL_DIMENSION + 31,
50 * CELL_DIMENSION + 56, "Instances", obj_player)
